...
const Notification: React.FC = () => {
  ...
  return (
    <div className="sm:mr-4 md:mr-6 ml-auto grid place-items-center relative">
      ...
      >
        <IconBell className="fill-black w-5 h-5 md:w-6 md:h-6 dark:fill-white" />
      </button>
      {notificationIsVisible && (
        <div className="absolute bg-[#FFFFFF] dark:bg-[#2C2C2C] top-full rounded-md left-0 p-3 w-52 border border-slate-300 dark:border-slate-700">
